...
PreparedStatement ps=con.prepareStatement("select * from revi where uname=?");
...
<%if(i==0) 
{
	out.println("<script>alert('Passenger Review Details Not Available');window.location='welcome_user.jsp';</script>");
}%>
<!-- css code -->
</div>
</div>
