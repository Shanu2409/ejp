...
<%@page import="tables.ProductDetails"%>
<%--<%@page import="database.ProductsDAOImpl"%>--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid mt-5">
            <h3 class="text-center">Study Books</h3>
...
//                    ProductsDAOImpl dao = new ProductsDAOImpl(DbConnect.getCon());
        ...
        <div class="container-fluid mt-5">
            <h3 class="text-center">Stories Books</h3>
            <div class="row ml-5 mr-5">
...
//                    ProductsDAOImpl dao = new ProductsDAOImpl(DbConnect.getCon());
        ...
        <div class="container-fluid mt-5">
            <h3 class="text-center">Novels</h3>
            <div class="row ml-5 mr-5">
