            ...
            <form action="bookTaxi" onsubmit="return check()">
                ...
                <label for="pickUp"><b>Select PickUp Location : </b></label>
                   <select class="select" name="pickUp" id="pickUp">
                    <option value="A">Borivali</option>
                    <option value="B">National Park</option>
                    <option value="C">Devipada</option>
                    <option value="D">Magathane</option>
                    <option value="E">Thakur Cinema</option>
                    <option value="F">Thakur College</option>
                   </select>
                    <br><br>
                    ...
                    <label for="pickUp"><b>Price : 500</b></label>
